...
class User(db.Model):
    ...
    status = db.Column(db.String(50), nullable=False, default="PENDING_VERIFICATION")
    created_at = db.Column(db.String(50), nullable=False, default=lambda: datetime.now(timezone.utc).isoformat())
